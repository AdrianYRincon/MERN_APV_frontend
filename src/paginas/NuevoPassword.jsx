  ...
  return (
    <>
        ...
        { msg && <Alerta alerta={alerta}/>}
          {/* si el token es valido entonces mostramos el html */}
          { tokenValido && ( 
             <>
             <form onSubmit={handleSubmit}>    
              ...
              <input type="submit" value="Guardar Nuevo Password" className="bg-indigo-700 w-full py-2 px-10 rounded-xl text-white uppercase font-bold hover:cursor-pointer hover:bg-indigo-800 md:w-auto" />
              </form>
