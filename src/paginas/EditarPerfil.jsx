          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="my-3">
              ...
              <input type='text'
                     ...
                     name='nombre'
                     value={perfil.nombre || ''}
                    //  aqui sacamos una copia de lo que hay en el objeto de perfil y despues modificamos el atributo de nombre
            ...
            <div className="my-3">
              ...
              <input type='text'
                     ...
                     name='web'
                     value={perfil.web || ''}
                    //  aqui sacamos una copia de lo que hay en el objeto de perfil y despues modificamos el atributo de web
                     onChange={ e => setPerfil({...perfil,[e.target.name]:e.target.value}) }/>
            ...
            <div className="my-3">
              ...
              <input type='text'
                    ...
                    //  aqui sacamos una copia de lo que hay en el objeto de perfil y despues modificamos el atributo de telefono
                     onChange={ e => setPerfil({...perfil,[e.target.name]:e.target.value}) }/>
            </div>
            ...
            <div className="my-3">
              ...
              <input type='text'
                     ...
                     name='email'
                     value={perfil.email || ''}
                    //  aqui sacamos una copia de lo que hay en el objeto de perfil y despues modificamos el atributo de email
                     onChange={ e => setPerfil({...perfil,[e.target.name]:e.target.value}) }/>
            </div>
