    ...
    <>
        ...
        { msg && <Alerta alerta={alerta}/>}
            ...
            onSubmit={handleSubmit}>
              ...
              <input type="submit" value="Enviar Instrucciones" className="bg-indigo-700 w-full py-2 px-10 rounded-xl text-white uppercase font-bold hover:cursor-pointer hover:bg-indigo-800 md:w-auto"/>
