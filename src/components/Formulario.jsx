...
const Formulario = () => {
  ...
  //Aqui estamos esperando por los cambios que pasen en el state de paciente para ejecutar el state
  useEffect( ()=>{
    if(paciente?.nombre){
  ...
  return (
    ...
    <p className="text-xl mt-5 mb-10 text-center">Añade tus y <span className="text-indigo-600 font-bold">Administralos</span>
    </p>
